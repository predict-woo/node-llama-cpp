...
export class LlamaContext {
    ...
    public getSequence(options: {
         ...
         * @see [Using Token Predictors](https://llama-cpp-node.withcat.ai/guide/token-prediction)
         */
...
export class LlamaContextSequence {
     ...
     * @see [Saving and restoring a context sequence evaluation state](https://llama-cpp-node.withcat.ai/guide/chat-session#save-and-restore-with-context-sequence-state)
     */
